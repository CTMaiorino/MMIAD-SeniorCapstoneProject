    ...
    render() {
        return (
            <div className={this.state.isVisible === true ? 'border' : ''}>
                ...
                <Button onClick={this.setVisibility}>{this.state.isVisible === true ? 'Hide' : 'Show'} </Button> 
                <h1 >Search Criteria</h1>
                </div>
                <Form variant='Primary' className={this.state.isVisible === true ? 'p-3 visable' : 'p-3 invisible'}  >
                    <Form.Group>
                        <Form.Label>Ensemble Gene ID:</Form.Label>
                        <Form.Control />
                        <Form.Label>Ensemble Transcript ID:</Form.Label>
                        <Form.Control />
                        ...
                        <Form.Check inline type="radio" label="+" onClick={this.onClick(1)} checked={this.state.radio === 1 ? true : false} />
                        <Form.Check inline type="radio" eventKey='-' label="-" onClick={this.onClick(2)} checked={this.state.radio === 2 ? true : false} />
                        <br></br>
